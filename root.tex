...
\diaa{diags/1.png}{Архитектура github.com}
\diaa{diags/2.png}{балансировщик}
\pagebreak
\diaa{diags/databases.png}{базы данных}
\diaa{diags/file-server.png}{файл сервера}
\pagebreak
\diaa{diags/frontend.png}{frontend сервер}
\pagebreak
\diaa{diags/github.png}{часть архитектуры}
\pagebreak
\diaa{diags/Diagram1.png}{архитектура предприятия}
\pagebreak
...
wiki.xenproject.org/wiki/Xen\_Project\_Beginners\_Guide\\
business.radario.ru\\
